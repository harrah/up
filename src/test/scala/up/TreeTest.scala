...
object TreeTest {
  ...
  val true =  toBoolean[ Not[B#Contains[_3]] && Not[B#Contains[_5]] &&
    B#Contains[_1] && B#Contains[_14] && B#Contains[_9] && B#Contains[_8] ]
  val true =  toBoolean[ Not[C#Contains[_3]] && Not[C#Contains[_5]] &&
    Not[C#Contains[_1]] && C#Contains[_14] && C#Contains[_9] && C#Contains[_8] && C#Contains[_15] ]
  ...
  def run() {
    ...
    println( toInt[ List#Head#_1 ] + ", " + toInt[ List#Tail#Head#_1 ]  +
      ", " + toInt[ List#Tail#Tail#Head#_1 ]  + ", " + toInt[ List#Tail#Tail#Tail#Head#_1 ])
  }
}*/
