...
object Select {
  ...
  implicit def consSelect[H, T <: HList, Data <: HList](implicit headSelect: Select[Data, H],
    tailSelect: KSelect[Data, T]): KSelect[Data, H :: T] =
  ...
  implicit def selectN[At, H, T <: HList, S <: Select[T, At]](implicit tail: S): Select[H :: T, At] =
    new Select[H :: T, At] {
